			...
			<Tabs>
				<TabPanel label="2026">
					...
					<Notification version="7.3.0" {...props}>
						<li>
							...
							<code>README.md</code> and <code>webmaker.json</code> alongside
							the source.
						</li>
					...
					<Notification version="7.2.0" {...props}>
						<li>
							<strong>Larger Local Assets</strong>: The local assets file size
							limit has been increased from 5MB to 10MB per file.
						</li>
						<li>
							<strong>Full Preview Shortcut</strong>: Toggle the full screen
							preview layout with <code>Ctrl/⌘ + Alt/Opt + P</code>.
						</li>
					</Notification>
					...
					<Notification version="7.1.0" {...props}>
						<li>
							...
							preset the preprocessor mode for each editor when opening Web
							Maker.
						</li>
					</Notification>
					...
					<Notification version="7.0.0" {...props}>
						<li>
							<strong>Local Assets</strong>: Add images, scripts, and other
							files from your machine and use them in your creations. Available
							to all users, no PRO required. Access from the "Local" tab in the
							Assets panel.
						</li>
						<li>
							<strong>Babel Updated</strong>: ES6 (Babel) mode now uses Babel 7
							with modern JavaScript support.
						</li>
					</Notification>
					...
					<Notification version="6.9.0" {...props}>
						<li>
							...
							panes show as tabs instead of side-by-side, giving you more
							vertical space for each editor.
						</li>
						<li>
							<strong>Keyboard Shortcuts</strong>: Use Ctrl/⌘ + Alt/Opt + 1/2/3
							to quickly switch focus between HTML, CSS and JS panes. Use Ctrl/⌘
					...
					<Notification version="6.8.0" {...props}>
						...
						<li>
							<strong>Minimize Panes</strong>: Code panes now have a minimize
							button to minimize any pane whenever required.
						</li>
						<li>
							Feedback can now be sorted either by "most votes" or "most recent"
					...
					<Notification version="6.7.0" {...props}>
						<li>
							...
							assign creations to one or more collections, and filter by
							collection to quickly find what you need. Double-click a
							collection to rename it, right-click to delete.
						</li>
					</Notification>
					...
					<Notification version="6.6.0" {...props}>
						<li>
							...
							"Collab" button in the header to start a session and share the
							link with your friends. Be it pair-programming, interviews or just
							helping out a friend, Web Maker's Collab gives you a nice
					...
					<Notification version="6.5.1" {...props}>
						<NotificationItem type="ui">
							The whole app interface now switches to Light theme when light
							theme is selected for the Editor.
						</NotificationItem>
						<NotificationItem type="bug">
							Console is back again!
						</NotificationItem>
						<NotificationItem type="ui">
							Editor theme can now be previewed when changing from Settings.
						</NotificationItem>
						<li>
							New additional keyboard shortcut added to refresh preview
							manually: <kbd class="kbd-shortcut__keys">Ctrl + Enter</kbd>.
						</li>{' '}
						<li>
				...
				<TabPanel label="2024">
					<Notification version="6.4.0" {...props}>
						<li>
							<strong>Assets inlining in "Save as HTML"</strong>: You now have
							an option to inline all the external assets (images,
							audios,videos) in the HTML file when you save the creation as
							HTML. This is useful when you want to share the HTML file with
							someone and want it to work offline. Currently supports assets
							defined in HTML file only.
						</li>
					</Notification>
					...
					<Notification version="6.3.6" {...props}>
						<NotificationItem type="bug">
							Import of creations (in logged in state) now always works even if
							the same creations have been imported to some other account.
						</NotificationItem>
					</Notification>
					...
					<Notification version="6.3.0" {...props}>
						<NotificationItem type="bug">
							Extension Only: JavaScript is NOW WORKING, again! 🎉 The extension
							is now migrated to MV3 which means its much more secure, and of
							course, JavaScript now works again! 🥳
						</NotificationItem>
						<NotificationItem type="ui">
							Tailwind CSS 2 template has been removed since Extension now
							supports the lateat Tailwind CSS 3 template.
						</NotificationItem>
					</Notification>
					...
					<Notification version="6.2.0" {...props}>
						...
						<NotificationItem type="bug">
							Localstorage/Cookies not being available to creations is now
							fixed.
						</NotificationItem>
						<NotificationItem type="bug">
					...
					<Notification version="6.1.0" {...props}>
						<li>
							<strong>🕹️ Kaboom game engine</strong>: Kaboom.js is now available
							in quick-add library list. Also, a new template to quick-start in
							Kaboom has been added.
						</li>
						<NotificationItem type="bug">
					...
					<Notification version="6.0.0" {...props}>
						<li>
							...
							buy. The PRO plan is available as monthly/annual subscription as
							well as a one-time lifetime price! Let's see what you get as a
							PRO.
						</li>
						<li>
							<strong>🔓 Share your creations</strong>: Web Maker has always
							been a privacy-first app. Continuing that culture, today we
							introduce "Share your creation" feature. Your creations are still
							created as private but now you can securely make them public to
							share with the world. As a free user you can have 1 creation
							public at a time. Upgrading to PRO gives you unlimited public
							creations.
						</li>
						<li>
							<strong>🗄️ Asset hosting</strong>: No more going to other places
							in order to host your images, CSS or JS files. Web Maker PRO gives
							you the ability to host your assets right inside Web Maker. You
							can upload images, CSS and JS files and use them in your
							creations.
						</li>
						<li>
							<strong>📁 Files mode</strong>: As a free user you could always
							create 2 creations in Files mode. With PRO, you can create
							unlimited creations in Files mode.
						</li>
						<NotificationItem type="ui">
							Web app is now available on webmaker.app/create (Previously
							available on webmaker.app/app)
						</NotificationItem>
						<NotificationItem type="ui">
					...
					<Notification version="5.3.0" {...props}>
						<li>
							<strong>Tailwind CSS templates</strong>: Tailwind CSS template is
							now available! If you are on the Chrome extension, use the
							Tailwind CSS 2 template which is old but works without JavaScript
							(since JavaScript is disabled currently in Chrome extension). That
							said, JavaScript is coming back soon to the Chrome extension! 😃
						</li>
					...
					<Notification version="5.2.0" {...props}>
						<li>
							...
							updated to latest version. Now you can do things like Grid and
							more!
						</li>
						<li>
				...
				<TabPanel label="2022">
					<Notification version="5.0.0" {...props}>
						<li>
							...
							being shipped, we are back in action. That too with a bang! We
							have a small team of amazing developers working on Web Maker now.
							So expect some crazy useful features coming soon!
						</li>
						<NotificationItem type="ui">
							First up, is local language support! We have added Hindi and
							Spanish to start with! Thanks{' '}
							<ThanksTo
				...
				<TabPanel label="2019">
					...
					<Notification version="4.0.2" {...props}>
						<li>
							You can now override settings through query parameters. Currently
							only <strong>autoPreview</strong> and{' '}
							<strong>isMonacoEditorOn</strong> are supported. Example:{' '}
							<code>
					...
					<Notification version="4.0.1" {...props}>
						<NotificationItem type="bug">
							Buggy full-screen option in Files mode. The option is removed till
							it works correctly with Files mode
						</NotificationItem>
						<NotificationItem type="bug">
						...
						<NotificationItem type="bug">
							JavaScript evaluation failing randomly with errors like const
					...
					<Notification version="4.0.0" {...props}>
						<p>
							Sit tight, because this is going to be some amazing set on updates
							for you! Read{' '}
							<a
						...
						<ul>
							<li>
								...
								<a href="https://webmaker.app">https://webmaker.app</a> 😀 The
								old website will continue to run for a month or so, but will
								eventually start redirecting to the new website. If you have an
								online account in Web Maker, you need not worry. But if you have
								some locally saved creations, you should{' '}
								<a
							...
							<li>
								<strong>📁 Files Mode</strong>: Hear this - you can now work
								with files just like you do in your local environment! No more
								working in just 3 panes. Try creating a new creation. "Files
								Mode" is in beta and you can currently only save 2 creations in
								this mode.
							</li>
							<li>
								<strong>🎨 Command Palette</strong>: We all love this, don't we?
								Taking frequent actions is now much quicker with the all new
								Command Palette. Hit Ctrl/Command+Shift+P, and give it a spin.
							</li>
							<li>
							...
							<li>
								...
								instead of CodeMirror editor from the settings. Though this is
								still an experimental feature and might contain bugs.
							</li>
							<li>
							...
							<NotificationItem type="ui" label="Settings">
								Settings screen got a complete makeover and now it's much easier
				...
				<TabPanel label="2018">
					<Notification version="3.6.0" {...props}>
						<li>
							<strong>New Setting</strong>: Configure if you want to auto-close
							the tags in HTML. (#347)
						</li>
						<li>
							<strong>Prettier</strong>: Prettier now works on HTML also! Also
							the keyboard shortcut has been changed to <kbd>Ctrl</kbd> +{' '}
							<kbd>Shift</kbd> + <kbd>F</kbd>.
						</li>

						<li>
							No more anonying alert on opening Web Maker in multiple tabs.
							Thanks team Firebase :) (#340)
						</li>
					...
					<Notification version="3.5.1" {...props}>
						<li>
							...
							Shift+Tab now uses Prettier to auto-format. This will improve UX
							wise in coming versions.
						</li>
					</Notification>

					<Notification version="3.5.0" {...props}>
						<li>
							<strong>New Template</strong>: Template for Vue.js is available
							when you start a new creation. Thanks{' '}
					...
					<Notification version="3.4.0" {...props}>
						...
						<NotificationItem type="ui">
							Migrate remaining interface elements to dark theme. Now complete
							app is in dark theme.
						</NotificationItem>
						<NotificationItem type="bug">
							Fix "Save as HTML" and "Take Screenshot" features in Chrome
							extension.
						</NotificationItem>
					</Notification>
					...
					<Notification version="3.3.2" {...props}>
						...
						<li>
							<strong>[Dev] Tests</strong>: We now have one running automated
							test :) More to come. Thanks{' '}
					...
					<Notification version="3.3.0" {...props}>
						<li>
							<strong>🔥 [Dev] Code Refactor</strong>: I rewrote Web Maker. Yes,
							Web Maker's codebase has been ported from plain JS to{' '}
							<a
							...
							. What does this mean for you as a end-user? This means that now
							that the code is much smaller, more modular and maintainable.
							Hence, future features can be developed more rapidly. So fasten
							your seat belts, and get ready to use loads of new features coming
							your way in next releases!
							<br />
							<a
					...
					<Notification version="3.2.0" {...props}>
						<li>
							<strong>🚀 Loop timeout setting</strong>: You now have a setting
							to tweak the maximum timeout of a loop iteration before it's
							marked as infinite loop.
						</li>
						<NotificationItem type="a11y">
					...
					<Notification version="3.1.1" {...props}>
						<NotificationItem type="bug">
							Fix the "Run" button not refreshing the preview after release
							3.0.4.
						</NotificationItem>
					</Notification>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								Web Maker is no more just a Chrome extension, it is also
								available as web app that runs offline just like the extension!
								Checkout it out -&gt;
								<a
							...
							<li>
								<strong>User Accounts</strong> - The much requested user
								accounts are here. Now maintain your account and store all your
								creations in the cloud and access them anywhere anytime.
							</li>
							<li>
								<strong>New layout mode</strong> - One more layout mode, that
								lets you align all the panes vertically.
							</li>
							<li>
				...
				<TabPanel label="2017">
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Bugfix</strong> - Stop screenlog.js from showing up in
								the exported HTML.
							</li>
							<li>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Bugfix</strong> - Console's z-index issue has been
								fixed.
							</li>
						</ul>
					</div>
					...
					<div class="notification">
						...
						<ul>
							<li>
								Choose the save location while exporting your saved creations.
							...
							<li>
								<strong>Bugfix</strong> - Console.clear now works in detached
								mode too.
							</li>
							<li>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Atomic CSS (Atomizer) configurations</strong> - Add
								custom config for Atomic CSS.
								<a
							...
							<li>
								<strong>Preserve logs setting</strong> - Choose whether or not
								to preserve logs across preview refreshes. Thanks
								<a
					...
					<div class="notification">
						...
						<ul>
							<li>
								Vue.js & UIKit version updated to latest version in 'Add
								Library' list.
							</li>
							<li>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Matching Tag Highlight</strong> - Cursor over any HTML
								tag would highlight the matching pair tag.
							</li>
							<li>
								Auto-completion suggestion can now be switched off from
								settings.
							</li>
							<li>
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>External Libraries</strong> - Add Foundation.js and
								update UIKit 3 to latest beta.
							</li>
							<li>
								<strong>rawgit.com</strong> &<strong>wzrd.in</strong> domains
								are now allowed for loading external libraries from.
							</li>
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>Fork any creation!</strong>: Now you can fork any
								existing creation of yours to start a new work based on it. One
								big use case of this feature is "Templates"!
								<a
									target="_blank"
									rel="noopener noreferrer"
							...
							<li>
								Great news to share with you - Web Maker has been featured on
								the Chrome Webstore homepage! Thanks for all the love :)
							</li>
						</ul>
					</div>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Bugfix</strong>: External libraries added to the
								creation are exported as well to Codepen.
							</li>
						</ul>
					</div>
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>The "Console"</strong>: The most awaited feature is
								here! There is now an inbuilt console to see your logs, errors
								and for quickly evaluating JavaScript code inside your preview.
								Enjoy! I also a
								<a
							...
							<li>
								Number slider which popped on clicking any number in the code
								has been removed due to poor user experience.
							</li>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Configurable Auto-preview</strong> - You can turn off
								the auto preview in settings if you don't want the preview to
								update as you type.
							</li>
							<li>
								<strong>Configurable refresh on resize</strong> - You can
								configure whether you want the preview to refresh when you
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>Improved infinite loop protection</strong>: Infinite
								loop protection is now faster and more reliable. And works
								without the need of Escodegen. Thanks to Ariya Hidayat!
							</li>
							<li>
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>Import/Export</strong>: Your creations are most
								important. Now export all your creations into a single file as a
								backup that can be imported anytime & anywhere.
							</li>
							<li>
							...
							<li>
								<strong>Identation settings</strong>: Not a spaces fan? Switch
								to tabs and set your indentation size.
							</li>
							<li>
							...
							<li>
								...
								(localhost, https://ajax.googleapis.com,
								https://code.jquery.com, https://cdnjs.cloudflare.com,
								https://unpkg.com, https://maxcdn.com, https://cdn77.com,
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Preview Screenshot Capture</strong> - Want to grab a
								nice screenshot of your creation. You have it! Click and
								capture.
							</li>
							<li>
							...
							<li>
								<strong>Bugfix</strong> - Fix in generated title of new
								creation.
							</li>
							<li>
								<strong>Bugfix</strong> - HTML autocompletion is manual
								triggered now with Ctrl+Space.
							</li>
						</ul>
					</div>
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>Code Autocompletion</strong> - See code suggestions
								while you type!
							</li>
							<li>
								<strong>Full Screen Preview</strong> - Checkout your creation in
							...
							<li>
								<strong>Bugfix</strong> - Works even in Chrome Canary now.
								Though libraries can be added only through CDNs.
							</li>
						</ul>
					</div>
					...
					<div class="notification">
						...
						<ul>
							<li>
								<strong>TypeScript</strong> - Now you can code in TypeScript
								too!
							</li>
							<li>
								<strong>Stylus Preprocessor</strong> - Stylus supported adding
								for CSS.
							</li>
							<li>
					...
					<div class="notification">
						...
						<ul>
							...
							<li>
								<strong>Collapsed Panes</strong> - Collapse/uncollapse code
								panes with a single click. Your pane configuration is even saved
								with every creation!
							</li>
							<li>
								<strong>Quick color & number change</strong> - Click on any
								color or number and experiment with quick values using a slider.
							</li>
							<li>
