			...
			<div id="footer" class="footer">
				<div>
					...
					<a
						...
						href="http://twitter.com/share?url=https://www.zenuml.com/&text=ZenUML - A blazing fast %26 offline web playground! via @ZenUML&related=ZenUML&hashtags=web,frontend,playground,offline"
						target="_blank"
						rel="noopener noreferrer"
					>
						<svg
