...
import MultiplayerIndicator from './MultiplayerIndicator.jsx';
			...
			{({ i18n }) => (
				<div class="main-header">
					...
					<div class="main-header__btn-wrap  flex  flex-v-center">
						...
						{!isFileMode && !multiplayerSession && (
							<button
								class="btn btn--dark hint--bottom-left"
								aria-label={i18n._(t`Start multiplayer collaboration session`)}
								data-testid="multiplayerButton"
								onClick={onMultiplayerBtnClick}
							>
						...
						{multiplayerSession && (
							<MultiplayerIndicator
								...
								onOpenModal={onMultiplayerModalOpen}
								onLeave={onMultiplayerLeave}
							/>
						)}
