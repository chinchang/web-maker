					...
					<div class="main-header__btn-wrap  flex  flex-v-center">
						...
						{!isFileMode && (
							<CollabButton
								...
								multiplayerParticipants={multiplayerParticipants}
								multiplayerConnectionStatus={multiplayerConnectionStatus}
								onMultiplayerBtnClick={onMultiplayerBtnClick}
								onMultiplayerModalOpen={onMultiplayerModalOpen}
								onProModalOpen={onProModalOpen}
							/>
						)}
