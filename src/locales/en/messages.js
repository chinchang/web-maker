/* eslint-disable */ export default {
	...
	messages: {
		...
		"Add files locally, usable only on this browser. Won't work for others if you share this publicly.":
			"Add files locally, usable only on this browser. Won't work for others if you share this publicly.",
		'Add library': 'Add library',
		'Add some code before exporting.': 'Add some code before exporting.',
		...
		'Copy the token and paste it below.': 'Copy the token and paste it below.',
		'Could not connect to GitHub.': 'Could not connect to GitHub.',
		'Could not validate token.': 'Could not validate token.',
		'Create New': 'Create New',
		'Create new Gist': 'Create new Gist',
		'Creating new Gist\u2026': 'Creating new Gist\u2026',
		...
		'Export all your creations into a single importable file.':
			'Export all your creations into a single importable file.',
		'Export as new gist': 'Export as new gist',
		'Export to Gist': 'Export to Gist',
		'Export to GitHub Gist': 'Export to GitHub Gist',
		'Exported to Gist': 'Exported to Gist',
		'Exporting to Gist\u2026': 'Exporting to Gist\u2026',
		...
		'Gist was deleted on GitHub': 'Gist was deleted on GitHub',
		'GitHub access expired': 'GitHub access expired',
		...
		'Manage your code in files. Just like you would have files on your local machine.':
			'Manage your code in files. Just like you would have files on your local machine.',
		'Max 10MB per file': 'Max 10MB per file',
		...
		New: 'New',
		'New gist created': 'New gist created',
		No: 'No',
		...
		'Once you stop typing, the preview waits for this much time before getting updated. Too low value might choke your browser!':
			'Once you stop typing, the preview waits for this much time before getting updated. Too low value might choke your browser!',
		Open: 'Open',
		'Open GitHub\'s "New token" page': 'Open GitHub\'s "New token" page',
		...
		"Paste a GitHub personal access token with the <0>gist</0> scope. It's stored only on this device.":
			"Paste a GitHub personal access token with the <0>gist</0> scope. It's stored only on this device.",
		'Paste a token to continue.': 'Paste a token to continue.',
		...
		'Report a bug': 'Report a bug',
		'Requires the <0>gist</0> scope.': 'Requires the <0>gist</0> scope.',
