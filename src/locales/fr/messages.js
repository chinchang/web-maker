/* eslint-disable */ export default {
	...
	messages: {
		...
		'Drop files or click here to add':
			'D\xE9posez des fichiers ou cliquez ici pour ajouter',
		...
		'Focus CSS pane': 'Concentrez-vous sur le panneau CSS',
		...
		'Made with <0>\u2764\uFE0F</0>& <1>\uD83D\uDE4C</1> by <2>Kushagra Gour</2>':
			'Fabriqu\xE9 avec <0>\u2764\uFE0F</0>& <1>\uD83D\uDE4C</1> par <2>Kushagra Gour</2>',
		...
		'Switch to tabbed layout': 'Passer \xE0 une mise en page par onglets',
		Tabs: 'Onglets',
